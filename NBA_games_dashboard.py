...
def update_output_div(home_team, away_team):
    ...
    probability_of_winning = json_response['win_probability'] if winning_team == home_team else 1 - json_response['win_probability']

    return f'{winning_team} will win with a probability of ' f'{probability_of_winning}'
